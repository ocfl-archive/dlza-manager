...
require (
	github.com/je4/filesystem/v3 v3.0.30
...
require (
	...
	github.com/je4/utils/v2 v2.0.60 // indirect
	...
	go.ub.unibas.ch/cloud/certloader/v2 v2.0.22 // indirect
	go.ub.unibas.ch/cloud/genericproto/v2 v2.0.4 // indirect
	go.ub.unibas.ch/cloud/minikvstore v1.0.2 // indirect
	go.ub.unibas.ch/cloud/miniresolver/v2 v2.0.51 // indirect
